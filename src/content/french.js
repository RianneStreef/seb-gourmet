export const french = {
  ...
  welcomeText:
    "SEB GOURMET TRAITEUR est une société événementielle créée en 2011 au cœur de Villartier, petit hameau des Belleville en Tarentaise (Savoie). Nous fournissons tous types de prestations dans le lieu de votre choix (domicile, salle des fêtes, chalet de location, prestation champêtre...) avec ou sans personnel. Le panel de nos prestations s'étend des livraisons de crèches et écoles, aux cocktails (dînatoire ou non), aux repas de famille, de société, jusqu'aux mariages et autres cérémonies. Nous mettons l'accent sur des produits de qualité et transformés par du personnel qualifié (boulanger, pâtissier, charcutier traiteur...)",

  suggestionsHeader: "Nos suggestions du jour",
  ...
  moreInfo1: "Nous contacter pour plus de cocktails",
  ...
  moreInfo2: "Nous contacter pour plus de buffets",

  suggestion3Title: "Repas",
  suggestion3t1: "Les entrées",
  suggestion3p1:
  ...
  suggestion3t3: "Plateau de fromage",
  suggestion3t4: "Dessert",
  suggestion3p4: "Mignardises, tarte citron revisitée.",
  moreInfo3: "Nous contacter pour plus de meals",

  instaFeed: "Gallerie photo",
  ...
  copyright: "Seb Gourmet. Tous droits réservés. Creé par ",
};
