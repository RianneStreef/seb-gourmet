      ...
      <div>
        ...
        <div className="header-menu">
          <div id="nav" className="nav main-menu hidden-mobile top-header">
            <button
              className="nav__link hidden-desktop header-button close-button"
              onClick={closeNav}
            >
            ...
            <ul className="menu-list">
              ...
              <li className="menu-item">
                <Link to="welcome" spy={true} smooth={true} onClick={closeNav}>
              ...
              <li className="menu-item">
                <Link to="insta" spy={true} smooth={true} onClick={closeNav}>
                  <p className="nav-link">{language.menuInsta}</p>
                </Link>
              </li>
              <span className="dot">&#8226;</span>
              <li className="menu-item">
                <Link to="contact" spy={true} smooth={true} onClick={closeNav}>
