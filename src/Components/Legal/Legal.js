  ...
  return (
    <div>
      ...
      <p>
        ...
        site{" "}
        <a href="//https://sebgourmet-traiteur.com//">
          https://sebgourmet-traiteur.com/
        </a>{" "}
        l'identité des différents intervenants dans le cadre de sa réalisation
        et de son suivi :
      </p>
      <p>
        <strong>Propriétaire</strong> : Seb Gourmet Traiteur – 53402382500019 –
        Villartier 73440 LES BELLEVILLE
        <br />
      ...
      <p>
        ...
        décidée par Seb Gourmet Traiteur, qui s’efforcera alors de communiquer
      ...
      <p>
        Seb Gourmet Traiteur s’efforce de fournir sur le site{" "}
        <a href="//https://sebgourmet-traiteur.com//">
          https://sebgourmet-traiteur.com/
        </a>{" "}
      ...
      <p>
        Seb Gourmet Traiteur est propriétaire des droits de propriété
      ...
      <p>
        ...
        préalable de : Seb Gourmet Traiteur.
      </p>
      <p>
      ...
      <p>
        Seb Gourmet Traiteur ne pourra être tenue responsable des dommages
        directs et indirects causés au matériel de l’utilisateur, lors de
        l’accès au site https://sebgourmet-traiteur.com/, et résultant soit de
      ...
      <p>
        Seb Gourmet Traiteur ne pourra également être tenue responsable des
      ...
      <p>
        ...
        l’espace contact) sont à la disposition des utilisateurs. Seb Gourmet
        Traiteur se réserve le droit de supprimer, sans mise en demeure
        ...
        relatives à la protection des données. Le cas échéant, Seb Gourmet
        Traiteur se réserve également la possibilité de mettre en cause la
      ...
      <p>
        {" "}
        En tout état de cause Seb Gourmet Traiteur ne collecte des informations
      ...
      <p>
        ...
        rachat de Seb Gourmet Traiteur et de ses droits permettrait la
      ...
      <p>
        ...
        en place avec l’autorisation de Seb Gourmet Traiteur. Cependant, Seb
        Gourmet Traiteur n’a pas la possibilité de vérifier le contenu des sites
