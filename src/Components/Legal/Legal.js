  ...
  return (
    <div>
      ...
      <div className="legal">
        ...
        <p>
          {" "}
          En tout état de cause Seb Gourmet Traiteur ne collecte des
        ...
        <p>
          ...
          mis en place avec l’autorisation de Seb Gourmet Traiteur. Cependant,
          Seb Gourmet Traiteur n’a pas la possibilité de vérifier le contenu des
